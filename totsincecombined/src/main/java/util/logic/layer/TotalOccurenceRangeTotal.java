 ...
 * @author vipin
 */
public class TotalOccurenceRangeTotal {
    ...
    public void total_occurence_range_total(LinkedHashMap<Integer,Integer> hmapall)
    {
...
if(ResultDto.requestType=="MM")
   ...
   System.out.println("TO " + maptemp);
    
    ResultDto.settotalOccurenceRangeTotal(maptemp);
