...
public class GroupTheRangeMmNewLine {
    ...
    public static void main(String[] args) throws ParseException, IOException {
        ...
        new GroupTheRangeMmNewLine().groupingRangeStarts(filePath);
    }
    ...
    private void groupingRangeLogic(List<LineDTO> ldto) {
        ...
        hmaprangeinfo.put(5, " 1 X 10-18");
        hmaprangeinfo.put(20, " 2 X 10-18");
        hmaprangeinfo.put(45, " 3 X 10-18");
        hmaprangeinfo.put(80, " 4 X 10-18");
        hmaprangeinfo.put(125, " 5 X 10-18");

        hmaprangeinfo.put(10, " 1 X 19-27");
        hmaprangeinfo.put(40, " 2 X 19-27");
        hmaprangeinfo.put(90, " 3 X 19-27");
        hmaprangeinfo.put(160, " 4 X 19-27");
        hmaprangeinfo.put(250, " 5 X 19-27");


        hmaprangeinfo.put(17, " 1 X 27-36");
        hmaprangeinfo.put(68, " 2 X 27-36");
        hmaprangeinfo.put(153, " 3 X 27-36");
        hmaprangeinfo.put(272, " 4 X 27-36");
        hmaprangeinfo.put(2125, " 5 X 27-36");


        hmaprangeinfo.put(26, " 1 X 36-45");
        hmaprangeinfo.put(104, " 2 X 36-45");
        hmaprangeinfo.put(234, " 3 X 36-45");
        hmaprangeinfo.put(416, " 4 X 36-45");
        hmaprangeinfo.put(3250, " 5 X 36-45");

        hmaprangeinfo.put(37, " 1 X 46-54");
        hmaprangeinfo.put(148, " 2 X 46-54");
        hmaprangeinfo.put(333, " 3 X 46-54");
        hmaprangeinfo.put(592, " 4 X 46-54");
        hmaprangeinfo.put(4625, " 5 X 46-54");


        hmaprangeinfo.put(50, " 1 X 55-62");
        hmaprangeinfo.put(200, " 2 X 55-62");
        hmaprangeinfo.put(450, " 3 X 55-62");
        hmaprangeinfo.put(800, " 4 X 55-62");
        hmaprangeinfo.put(6250, " 5 X 55-62");

        hmaprangeinfo.put(65, " 1 X 63-70");
        hmaprangeinfo.put(260, " 2 X 63-70");
        hmaprangeinfo.put(585, " 3 X 63-70");
        hmaprangeinfo.put(1040, " 4 X 63-70");
        hmaprangeinfo.put(8125, " 5 X 63-70");
        ...
        System.out.println("*******************RANGE SQUARE*************************");
        ...
        for (Integer key : hmap2.keySet()) {
            ...
            System.out.println(hmaptotalinfo.get(key) + "\t" + hmap2.get(key));

        }
        System.out.println("*******************RANGE SUM*************************");
        HashMap<Integer, Integer> hmap3 = sortByValues_Int_Int(hmaprange);
        for (Integer key : hmap3.keySet()) {
            // System.out.println(key  + "\t" + hmaprange.get(key));

            if (key != 0) {
                System.out.println(hmaprangeinfo.get(key) + "\t" + hmap3.get(key));
